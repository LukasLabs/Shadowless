...
module.exports.load = async function (app, db) {
  app.get("/login", async (req, res) => {
    ...
    res.redirect(
      `https://discord.com/api/oauth2/authorize?client_id=${
        ...
        settings.api.client.oauth2.prompt == false ? "" : "&prompt=none"
      }`
    );
  });
  ...
  app.get(settings.api.client.oauth2.callbackpath, async (req, res) => {
    ...
    <body style="font-family: 'Inter'" class="bg-stone-900 flex flex-col items-center justify-center min-h-screen">
        <div class="flex flex-col items-center">
          <svg class="animate-spin h-8 w-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <p class="mt-4 text-stone-300 font-semibold text-sm">Logging in...</p>
        </div>
    </body>
    </html>
